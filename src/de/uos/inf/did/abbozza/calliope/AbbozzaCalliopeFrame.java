...
import de.uos.inf.did.abbozza.core.AbbozzaLoggerListener;
...
public class AbbozzaCalliopeFrame  extends javax.swing.JFrame implements AbbozzaLoggerListener, AbbozzaCalliopeGUI, DocumentListener {
    ...
    private void initComponents() {
        ...
        incFontSizeItem = new javax.swing.JMenuItem();
        decFontSizeItem = new javax.swing.JMenuItem();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addComponent(messagePane, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        jMenu1.setText(AbbozzaLocale.entry("gui.view"));

        incFontSizeItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_PLUS, java.awt.event.InputEvent.CTRL_MASK));
        incFontSizeItem.setText(AbbozzaLocale.entry("gui.inc_font_size"));
        incFontSizeItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                incFontSizeItemActionPerformed(evt);
            }
        });
        jMenu1.add(incFontSizeItem);

        decFontSizeItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_MINUS, java.awt.event.InputEvent.CTRL_MASK));
        decFontSizeItem.setText(AbbozzaLocale.entry("gui.dec_font_size"));
        decFontSizeItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                decFontSizeItemActionPerformed(evt);
            }
        });
        jMenu1.add(decFontSizeItem);
    ...
    private void incFontSizeItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_incFontSizeItemActionPerformed
        Font oldfont = sourceArea.getFont();
        int size = ( oldfont.getSize()+1 ) % 80;
        Font newfont = new Font("Cour<ier New",Font.PLAIN,size);
        if ( !newfont.getFontName().equals("Courier New") ) {
           newfont = new Font("DejaVu Sans Mono",Font.PLAIN,size); 
        }
        sourceArea.setFont(newfont);
    }//GEN-LAST:event_incFontSizeItemActionPerformed

    private void decFontSizeItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decFontSizeItemActionPerformed
        Font oldfont = sourceArea.getFont();
        int size = ( oldfont.getSize()-1 );
        if ( size < 5 ) size = 5;
        Font newfont = new Font("Cour<ier New",Font.PLAIN,size);
        if ( !newfont.getFontName().equals("Courier New") ) {
           newfont = new Font("DejaVu Sans Mono",Font.PLAIN,size); 
        ...
        sourceArea.setFont(newfont);
    }//GEN-LAST:event_decFontSizeItemActionPerformed
    ...
    private javax.swing.JMenuItem decFontSizeItem;
    private javax.swing.JPanel editorPane;
    private javax.swing.JRadioButtonMenuItem errMenuItem;
    private javax.swing.JMenuItem incFontSizeItem;
