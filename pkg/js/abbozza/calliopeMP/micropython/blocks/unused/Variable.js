...
Abbozza.VariableBlock = {
    ...
    init: function () {
        ...
        this.appendDummyInput()
                .appendField(new VariableDropdown(this, function (name) {
                    ...
                    this.sourceBlock_.setOutput(true,[this.symbol[1], "VAR" + this.symbol[1], "VAR"]);
                    // this.sourceBlock_.render();
                    return this.symbol[0];
                }), "NAME");
        this.setOutput(true, ["VAR", "NUMBER", "STRING", "DECIMAL", "BOOLEAN"]);
    ...
    domToMutation: function (xmlElement) {
        ...
        if (this.symbol) {
            this.setOutput(true,[this.symbol[1], "VAR" + this.symbol[1], "VAR"]);
        }
    },
    getSymbol: function () {
        if (this.symbol != null) {
...
Abbozza.VariableAssign = {
    init: function () {
        this.setHelpUrl(Abbozza.HELP_URL);
        this.setColour(ColorMgr.getCatColor("cat.VAR"));
        this.appendValueInput("LEFT").appendField(__("var.SET", 0));
    ...
    onchange: function () {
        ...
        if (variable != null) {
            // console.log(variable.getFieldValue("NAME"));
