...
Abbozza.SerialPrintLn = {
  ...
  generateCode : function(generator) {
  	...
  	var code = "abbozza.serial.send(" + value + ");\n";
  	var code = code + "abbozza.serial.send(\"\\n\");";
  	return code;
  }
}
...
Abbozza.SerialReadLn = {
  ...
  generateCode : function(generator) {
  	...
  	var code = "abbozza.serial.readUntil(\"\\n\")";
  	return code;
    }
}
...
Abbozza.SerialTable = {
  ...
  generateCode : function(generator) {
  	...
  	// var code = "__measure("+pin0+","+pin1+","+pin2+","+pin3+","+pin4+");";
        var code = 'abbozza.serial.printf("[[table %s,%d,%d,%d,%d,%d,%d]]\\n","'+ type +'",abbozza.systemTime(),';
