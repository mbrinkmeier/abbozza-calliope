...
Abbozza.DeviceSpeakerSymbols = ["C","♯C/♭D","D","♯D/♭E","E","F","♯F/♭G","G","♯G/♭A","A","♯A/♭H","H"];
...
Abbozza.MicrophoneGet = {
    init : function() {
        ...
        this.setOutput(true,"NUMBER");
        this.appendDummyInput()
            .appendField(_("dev.MICROPHONE_GET"))
        this.setTooltip('');
    },
    
    generateCode : function(generator) {
        var code="";
        code = "abbozza.getMicrophoneLevel()";
        return code;
    }
}

Blockly.Blocks['dev_microphone_get'] = Abbozza.MicrophoneGet;
