...
Abbozza.DisplaySetPixel = {
    ...
    generateCode : function(generator) {
        ...
        code = "abbozza.display.image.setPixelValue("+col+","+row+","+color+");";
        return code;
    }
}
...
Abbozza.DisplayImage = {
    ...
    generateCode: function(generator) {
        ...
        generator.addSetupCode("const uint8_t __image_" + counter + "_data__[] __attribute__ ((aligned (4))) = { 0xff,0xff,5,0,5,0," + imgcode + " };");
        generator.addSetupCode("MicroBitImage __image_" + counter + "__((ImageData*)__image_" + counter + "_data__);");
        return "abbozza.display.image.paste(__image_" + counter + "__);";
        // return code;
    }
}
