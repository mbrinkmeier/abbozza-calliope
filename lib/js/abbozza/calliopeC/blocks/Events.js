...
Abbozza.Event.prototype.init = function() {
  ...
  this.appendDummyInput()
      .appendField(_("gui.when"))
        .appendField(new Blockly.FieldDropdown(this.eventList), "EVENT");
  this.appendStatementInput("STATEMENTS")
      .setCheck("STATEMENT");
  this.setTooltip('');
  this.setMutator(new DynamicMutator(function () {
...
Abbozza.Event.prototype.generateCode = function (generator) {
    ...
    generator.initHookCode = initHookCode + initCode;
...
//Abbozza.Event.prototype.updateLook = function () {
//        var no = Abbozza.deleteInputs(this, "VAR");
//
//        var no = 0;
//        var params = "";
