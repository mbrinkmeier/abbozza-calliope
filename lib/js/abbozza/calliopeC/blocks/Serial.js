...
Abbozza.SerialPrintLn = {
  ...
  generateCode : function(generator) {
  	...
  	var code = "calliope.serial.send(" + value + ");\n";
  	var code = code + "calliope.serial.send(\"\\n\");";
  	return code;
  }
}
...
Abbozza.SerialReadLn = {
  ...
  generateCode_ : function(generator) {
  	...
  	var code = "calliope.serial.readUntil(\"\\n\")";
  	return code;
    }
}
...
Abbozza.SerialTable = {
  ...
  generateCode : function(generator) {
  	...
  	// var code = "__measure("+pin0+","+pin1+","+pin2+","+pin3+","+pin4+");";
        var code = 'calliope.serial.printf("[[table %s,%d,%d,%d,%d,%d,%d]]\\n","'+ type +'",calliope.systemTime(),';
