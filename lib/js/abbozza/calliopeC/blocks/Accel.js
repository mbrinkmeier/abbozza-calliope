...
Abbozza.AccelGet = {
    ...
    generateCode : function(generator) {
        generator.addInitCode("abbozza.accelerometer.configure();");
        generator.addInitCode("abbozza.accelerometer.updateSample();");
        var code="";
...
Abbozza.AccelWasGesture = {
    ...
    [_("dev.2G"),"MICROBIT_ACCELEROMETER_EVT_2G"],
    ...
    generateCode : function(generator) {
        ...
        generator.addInitCode("abbozza.accelerometer.updateSample();");
        var code="";
        var gesture = generator.fieldToCode(this,"GESTURE");
        code = "(abbozza.getGesture() == " + gesture + ")";
        return code;
    }
}
...
Abbozza.CompassGetFS = {
    ...
    generateCode : function(generator) {
        generator.addInitCode("abbozza.compass.configure();");
        generator.addInitCode("abbozza.compass.updateSample();");
        var code="";
        var dir = generator.fieldToCode(this,"DIR");
...
Abbozza.ThermometerGet = {
    ...
    generateCode : function(generator) {
        generator.addInitCode("abbozza.thermometer.updateSample();");
        var code="";
